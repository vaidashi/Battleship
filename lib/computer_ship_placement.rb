...
class ComputerShipPlacement
  ...
  def three_unit_ship_middle_coord
    if three_unit_ship_first_coord == "A1" && three_unit_ship_mid_coord == "A3"
      @three_unit_ship_mid_coord = "A2"
    elsif three_unit_ship_first_coord == "A1" && three_unit_ship_mid_coord == "C1"
      @three_unit_ship_mid_coord = "B1"
    elsif three_unit_ship_first_coord == "A2" && three_unit_ship_mid_coord == "A4"
      @three_unit_ship_mid_coord = "A3"
    elsif three_unit_ship_first_coord == "A2" && three_unit_ship_mid_coord == "C2"
      @three_unit_ship_mid_coord = "B2"
    elsif three_unit_ship_first_coord == "A3" && three_unit_ship_mid_coord == "A1"
      @three_unit_ship_mid_coord = "A2"
    elsif three_unit_ship_first_coord == "A3" && three_unit_ship_mid_coord == "C3"
      @three_unit_ship_mid_coord = "B3"
    elsif three_unit_ship_first_coord == "A4" && three_unit_ship_mid_coord == "A2"
      @three_unit_ship_mid_coord = "A3"
    elsif three_unit_ship_first_coord == "A4" && three_unit_ship_mid_coord == "C4"
      @three_unit_ship_mid_coord = "B4"
    elsif three_unit_ship_first_coord == "B1" && three_unit_ship_mid_coord == "B3"
      @three_unit_ship_mid_coord = "B2"
    elsif three_unit_ship_first_coord == "B1" && three_unit_ship_mid_coord == "D1"
      @three_unit_ship_mid_coord = "C1"
    elsif three_unit_ship_first_coord == "B2" && three_unit_ship_mid_coord == "B4"
      @three_unit_ship_mid_coord = "B3"
    elsif three_unit_ship_first_coord == "B2" && three_unit_ship_mid_coord == "D2"
      @three_unit_ship_mid_coord = "C2"
    elsif three_unit_ship_first_coord == "B3" && three_unit_ship_mid_coord == "B1"
      @three_unit_ship_mid_coord = "B2"
    elsif three_unit_ship_first_coord == "B3" && three_unit_ship_mid_coord == "D3"
      @three_unit_ship_mid_coord = "C3"
    elsif three_unit_ship_first_coord == "B4" && three_unit_ship_mid_coord == "B2"
      @three_unit_ship_mid_coord = "B3"
    elsif three_unit_ship_first_coord == "B4" && three_unit_ship_mid_coord == "D4"
      @three_unit_ship_mid_coord = "C4"
    elsif three_unit_ship_first_coord == "C1" && three_unit_ship_mid_coord == "C3"
      @three_unit_ship_mid_coord = "C2"
    elsif three_unit_ship_first_coord == "C1" && three_unit_ship_mid_coord == "A1"
      @three_unit_ship_mid_coord = "B1"
    elsif three_unit_ship_first_coord == "C2" && three_unit_ship_mid_coord == "C4"
      @three_unit_ship_mid_coord = "C3"
    elsif three_unit_ship_first_coord == "C2" && three_unit_ship_mid_coord == "A2"
      @three_unit_ship_mid_coord = "B2"
    elsif three_unit_ship_first_coord == "C3" && three_unit_ship_mid_coord == "C1"
      @three_unit_ship_mid_coord = "C2"
    elsif three_unit_ship_first_coord == "C3" && three_unit_ship_mid_coord == "A3"
      @three_unit_ship_mid_coord = "B3"
    elsif three_unit_ship_first_coord == "C4" && three_unit_ship_mid_coord == "C2"
      @three_unit_ship_mid_coord = "C3"
    elsif three_unit_ship_first_coord == "C4" && three_unit_ship_mid_coord == "A4"
      @three_unit_ship_mid_coord = "B4"
    elsif three_unit_ship_first_coord == "D1" && three_unit_ship_mid_coord == "D3"
      @three_unit_ship_mid_coord = "D2"
    elsif three_unit_ship_first_coord == "D1" && three_unit_ship_mid_coord == "B1"
      @three_unit_ship_mid_coord = "C1"
    elsif three_unit_ship_first_coord == "D2" && three_unit_ship_mid_coord == "D4"
      @three_unit_ship_mid_coord = "D3"
    elsif three_unit_ship_first_coord == "D2" && three_unit_ship_mid_coord == "B2"
      @three_unit_ship_mid_coord = "C2"
    elsif three_unit_ship_first_coord == "D3" && three_unit_ship_mid_coord == "D1"
      @three_unit_ship_mid_coord = "D2"
    elsif three_unit_ship_first_coord == "D3" && three_unit_ship_mid_coord == "B3"
      @three_unit_ship_mid_coord = "C3"
    elsif three_unit_ship_first_coord == "D4" && three_unit_ship_mid_coord == "D2"
      @three_unit_ship_mid_coord = "D3"
    elsif three_unit_ship_first_coord == "D4" && three_unit_ship_mid_coord == "B4"
      @three_unit_ship_mid_coord = "C4"
    end
  end
